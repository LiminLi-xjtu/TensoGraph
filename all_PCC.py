...
# 绘制盒子图
plt.figure(figsize=(7, 5.5))  # 设置图形大小(20,18),dpi=200

# 使用Seaborn绘制盒子图
ax1=sns.boxplot(data=df1[methods])#,linewidth=4
ax1.set_xticklabels([])
...
'''
plt.xticks(fontsize=18)#30
plt.yticks(fontsize=18)
plt.ylabel('PCC',fontsize=19,fontweight='bold')
# 使用 tight_layout() 自适应画布
plt.tight_layout()
# 设置标题
#plt.title('RMSE Box Plot for Different Methods across Cell Lines')
plt.savefig('/home/zhangdongxue/all_pcc/oneil/ALL_PCC_oneil_hsa.png')
